        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-white/80 mb-10 leading-relaxed">
              ...
              to exclusive vendor deals and local business discounts right at your fingertips.
            </p>

            {/* App Features */}
            <div className="space-y-6 mb-12">
              <div className="flex items-center">
                <div className="flex-shrink-0 w-12 h-12 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center mr-6 animate-glow">
                  <span className="text-white text-lg">⚡</span>
                </div>
                <span className="text-white/80 text-lg">Lightning-fast notifications for new deals</span>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 w-12 h-12 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center mr-6 animate-glow">
                  <span className="text-white text-lg">📍</span>
                </div>
                <span className="text-white/80 text-lg">Location-based vendor offers</span>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 w-12 h-12 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center mr-6 animate-glow">
                  <span className="text-white text-lg">🔔</span>
                </div>
                <span className="text-white/80 text-lg">Push notifications for important updates</span>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 w-12 h-12 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center mr-6 animate-glow">
                  <span className="text-white text-lg">💬</span>
                </div>
                <span className="text-white/80 text-lg">Direct messaging with sellers and event organizers</span>
              </div>
            </div>

            {/* Download Button */}
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
              <button className="bg-white text-black px-10 py-5 rounded-xl font-semibold hover:bg-white/90 transition-all duration-300 hover-lift animate-glow flex items-center justify-center space-x-4">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="absolute -top-12 -left-12 bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 animate-float glass-effect">
                <div className="text-white text-sm font-medium">💰 Save $50 this week!</div>
              </div>
              <div className="absolute -bottom-8 -right-8 bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 animate-float-delay glass-effect">
                <div className="text-white text-sm font-medium">🏪 5 vendors nearby</div>
              </div>
              ...
              <div className="relative bg-white p-3 rounded-[3rem] shadow-2xl animate-glow">
                <div className="bg-white rounded-[2.5rem] overflow-hidden w-80 h-[650px] relative border border-black/10">
                  ...
                  <div className="absolute inset-0 bg-white flex flex-col items-center justify-center p-8">
                    ...
                    />
                    <h3 className="text-2xl font-bold text-black mb-3 tracking-tight">Flin App</h3>
                    <p className="text-black/70 text-center text-lg mb-8">
                      Your campus life, simplified
                    </p>
                    <div className="w-full space-y-4">
                      <div className="bg-black/5 border border-black/10 p-4 rounded-xl">
                        <div className="text-sm font-medium text-black">🏷️ 15 new local offers</div>
                      </div>
                      <div className="bg-black/5 border border-black/10 p-4 rounded-xl">
                        <div className="text-sm font-medium text-black">🏷️ 3 active offers</div>
                      </div>
                      <div className="bg-black/5 border border-black/10 p-4 rounded-xl">
                        <div className="text-sm font-medium text-black">💰 Save $25 today</div>
                      </div>
                    </div>
                  </div>
                  
                  {/* Status Bar */}
                  <div className="absolute top-0 inset-x-0 h-10 bg-black rounded-t-[2.5rem] flex items-center justify-between px-8 text-white text-sm">
