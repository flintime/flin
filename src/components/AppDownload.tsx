          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start">
              <a
                ...
                className="bg-white text-black px-10 py-5 rounded-xl font-semibold hover:bg-white/90 transition-all duration-300 hover-lift flex items-center justify-center space-x-4"
              >
